...
<div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 style="color: #87B1FD" class="m-0 font-weight-bold">DATA BEBAN</h6>
            </div>
			  ...
			  <table class="table table-bordered" id="dataTable" data-toggle="table" data-pagination="true" data-search="true" >									
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="nama_beban" data-editable="true">Jenis Beban</th>
                                  ...
                                  <div class="modal-body">
										<form action="index.php?pages=crud&aksi=tambah-beban" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php
                                                $query=mysqli_query($conn,"SELECT*FROM akun WHERE kode_akun IN (51,52,53)");
