        ...
        <div class="card">
            <div class="body">
                <div class="card-header py-3">
                     <h6 style="color: #87B1FD" class="m-0 font-weight-bold">BUKU BESAR</h6>
                </div>
                <div class="card-body">
                    <div class="row clearfix">
                    <div style="padding-left: 10px;" class="col-xs-12">
                            <h6 class="card-inside-title">Pilih Rentang Tanggal</h6>
                            <form action="" method="POST">
                                <input style="border-radius: 3px;" type="date" name="awal">
                                s/d
                                <input style="border-radius: 3px;" type="date" name="akhir">
                                <button style="margin-left: 10px" class="btn btn-success" type="submit" name="range">Cari</button>
                             </form>
                        ...
                        <br>
                            ...
                            </button></a> *Pilih Rentang Tanggal Terlebih Dahulu
            
                            <a target="_blank" href='modules/cetak_bukubesar_all.php' style="position:relative; left:150px;">
                            <button style="margin-left: 150px" class="btn btn-white btn-success btn-bold">
...
$warna = "";
if($hitung2 == $hitung)
    $warna = " style='color:#fff;background: #87B1FD;'";
