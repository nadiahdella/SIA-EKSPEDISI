...
<div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 style="color: #87B1FD" class="m-0 font-weight-bold">DATA MODAL</h6>
            </div>
                              ...
                              <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
										<form action="<?php echo $base_url?>index.php?pages=crud&aksi=tambah-modal" method="POST" enctype="multipart/form-data">
